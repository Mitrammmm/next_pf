      ...
      <div className=" bg-white/20 min-h-screen">
        ...
        <header className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <nav className="space-x-6">
            <a className=" font-semibold tracking-widest text-sm uppercase cursor-pointer" href="#home">
              Home
            </a>
            <a className="font-semibold tracking-widest text-sm uppercase cursor-pointer" href="#projects">
              Projects
            </a>
            <a className="font-semibold tracking-widest text-sm uppercase cursor-pointer" href="#experience">
              Experience
            </a>
            <a className="font-semibold tracking-widest text-sm uppercase cursor-pointer" href="#skills">
              Skills
            </a>
            <a className="font-semibold tracking-widest text-sm uppercase cursor-pointer" href="#contact">
              Contact
            </a>
          </nav>
        </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className=" justify-center">
                ...
                <p className="mt-6 max-w-xl font-semibold">
                 I create fast, reliable and scalable web solutions.
                  <br></br>Full-Stack · System Design · DevOps.
                </p>
              </div>
